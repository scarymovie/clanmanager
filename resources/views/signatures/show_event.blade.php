                                ...
                                <tr class="border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td>
                                        @if(isset($member->eventMemberStatuses->first()->status) && $member->eventMemberStatuses->first()->status === 'confirmed')
                                            <a href="{{ route('events.masterUpdate', [$clan, $event, $member, 'status' => 'rejected', 'week' => $week]) }}"
                                        ...
                                        @elseif(isset($member->eventMemberStatuses->first()->status) && $member->eventMemberStatuses->first()->status === 'rejected')
                                            <a href="{{ route('events.masterUpdate', [$clan, $event, $member, 'status' => 'confirmed', 'week' => $week]) }}"
